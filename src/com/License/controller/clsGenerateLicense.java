...
public class clsGenerateLicense
{
	...
	try
	{
	    ...
	    inputMapClientDtl.put("048.001", new clsClientDetails("048.001", "WHITE CASTLE", "","2015-03-17", "2017-03-01", "Enterprise", "100", objNoSMSPackDtl, "1", "", "", "", "","No Bill Deletion"));
	    ...
	    inputMapClientDtl.put("140.001", new clsClientDetails("140.001", "THAAL FOOD CONCEPTS PVT LTD", "","2017-01-25", "2018-01-26", "Enterprise", "100", objNoSMSPackDtl, "0", "//released on 25-01-2017 for 1 year  ", "", "", "","No Bill Deletion"));
	    //sanguine
	    ...
	    inputMapClientDtl.put("162.001", new clsClientDetails("162.001", "SWEET LAVENDER FOODS LLP", "La Bouchee Second  Outlet","2017-04-20", "2018-05-02", "Enterprise", "1", objNoSMSPackDtl, "0", "//renewed on 21-04-2018 for 10 days till 02-05-2018//(071.001, La Bouchee dOr first licence ) released on 20-04-2017 for 1 year  Enterprise for 1 machines", "Mr. Dhananjay Raut", "8087891693", "dhananjay.raut@laboucheedor.com","No Bill Deletion"));
	    inputMapClientDtl.put("163.001", new clsClientDetails("163.001", "KADAR KHAN'S SHEESHA", "SHEESHA","2017-04-22", "2018-05-02", "Enterprise", "100", new clsSMSPackDtl("Sheesha", "2017@Sheesha@2017", "SANPOS", "Transactional"), "8", "//renewed on 23-04-2018 for 10 days till 02-05-2018// renewed on 02-11-2017 for 1 year Enterprise for 2 machines, SMS pack for 1K SMS", "Mr. Akash", "9923745566", "it@kapila.co.in","No Bill Deletion"));
	    inputMapClientDtl.put("164.001", new clsClientDetails("164.001", "GLOBAL FOODS & BEVERAGES PVT. LTD.", "","2017-04-26", "2018-04-26", "Enterprise", "1", objNoSMSPackDtl, "6", "// released on 26-04-2017 for 1 year  Enterprise for 1 terminal", "", "", "","No Bill Deletion"));
	    //cantos
	    ...
	    inputMapClientDtl.put("233.001", new clsClientDetails("233.001", "PLAYBOY INDIA", "PLAYBOY","2018-03-16", "2018-05-27", "Enterprise", "9", objNoSMSPackDtl, "5", "(MUMBAI)//renewed on 27-04-2018 for 1 month till 27-05-2018//release on 13-03-2018 for 1 months till 12-04-2018 for 9 SPOS ,5 APOS,1 WebStocks,No SMS Pack.", "Mr.Santosh", "9987326701", "Santosh_ply23@gmail.com","No Bill Deletion"));
	    ...
	    inputMapClientDtl.put("240.001", new clsClientDetails("240.001", "THOUSAND OAKS", "1000 OAKS","2018-03-27", "2018-05-11", "Enterprise", "5", objNoSMSPackDtl, "10", "(PUNE)//renewed on 25-04-2018 for 15 days till 11-05-2018//release on 27-03-2018 for 1 month till 26-04-2018 for 5 SPOS ,10 APOS,NO WebStocks,No SMS Pack.", "Mr. Shripad Tole", "8308318356", "info@1000oaksindia.com","Bill Deletion"));
	    inputMapClientDtl.put("241.001", new clsClientDetails("241.001", "LALITHA HOSPITALITY PVT LTD", "","2018-04-06", "2018-05-06", "Enterprise", "4", objNoSMSPackDtl, "6", "(MUMBAI)//release on 06-04-2018 for 1 month till 06-05-2018 for 4 SPOS ,6 APOS,1 WebStocks,No SMS Pack.", "Mr.Santosh Shetty", "+919769214553", "Santoshshetty_0173@gmail.com","No Bill Deletion"));
	    //242.001, "SRINATHJIS CUISINES PVT LTD" MMS License
	    inputMapClientDtl.put("243.001", new clsClientDetails("243.001", "SURANIMO RETAIL PRIVATE LIMITED","","2018-04-11", "2018-05-11", "Enterprise", "6", objNoSMSPackDtl, "2", "(MUMBAI)//release on 11-04-2018 for 1 month till 11-05-2018 for 6 SPOS ,2 APOS,NO WebStocks,No SMS Pack.", "Mr.Arya", "9617894217", "Aryapatil231@gmail.com","No Bill Deletion"));
