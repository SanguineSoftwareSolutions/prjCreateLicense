...
public class clsGenerateLicense
{
	...
	try
	{
	    ...
	    inputMapClientDtl.put("022.001", new clsClientDetails("022.001", "MR Fried Chicken", "", "2014-09-23", "2019-08-14", "Enterprise", "100", objNoSMSPackDtl, "1", "// renewed on 14-08-2017 for 1 year // renewed on 06-08-2018 for 1 year", "Pankaj", "9769986445", "Pankajsds@hotmail.com", "No Bill Deletion"));
	    ...
	    inputMapClientDtl.put("042.001", new clsClientDetails("042.001", "Ashoka Pure Veg", "Ashoka Pure Veg", "2015-01-09", "2019-05-31", "Enterprise", "100", new clsSMSPackDtl("AshokaPureVeg", "2017@AshokaPureVeg@2017", "SANPOS", "Transactional"), "0", "//renewed on 02-06-2018 for 1 year till 31-05-2019//renewed on 31-05-2017  for year,1000 SMS pack activated on 09-08-2017", "Mr. Ajit", "8237004565", "ashokahospitality@gmail.com", "No Bill Deletion"));
	    inputMapClientDtl.put("042.002", new clsClientDetails("042.002", "Ashoka Spice", "Ashoka Spice", "2015-01-09", "2017-01-09", "Enterprise", "100", objNoSMSPackDtl, "1", "", "", "", "", "No Bill Deletion"));
	    ...
	    inputMapClientDtl.put("048.001", new clsClientDetails("048.001", "JAI SANTOSHI MAA HOSPITALITY", "WHITE CASTLE", "2015-03-17", "2019-05-09", "Enterprise", "100", objNoSMSPackDtl, "7", "(MUMBAI)//renamed KINGS WHITE CASTLE to JAI SANTOSHI MAA HOSPITALITY and renewed 1 APOS to 7 APOS// renew on 10-05-2018 for 1 year till 09-05-2019 ", "Mr.Piyush", "9820759877", "piyush.ja@gmail.com", "No Bill Deletion"));
	    ...
	    inputMapClientDtl.put("054.001", new clsClientDetails("054.001", "J HEARSCH COMPANY", "J HEARSCH COMPANY", "2015-04-16", "2019-08-28", "Enterprise", "100", objNoSMSPackDtl, "1", "//renewed on 27-08-2018 for 1 year till 28-08-2019// renewed on 28-08-2017 for 1 year", "Mr. J Hearsh", "9820983135", "jhearsh.b@hotmail.com", "No Bill Deletion"));
	    ...
	    inputMapClientDtl.put("060.001", new clsClientDetails("060.001", "FLYING SAUCER SKY BAR", "Flying Saucer", "2015-06-01", "2019-06-01", "Enterprise", "100", new clsSMSPackDtl("FlyingSaucer", "2018@FlyingSaucer@2018", "SANPOS", "Transactional"), "1", "//renewed on 07-08-2018 till 01-06-2019//renewed on 26-07-2018 till 06-08-2018  //renewed on 25-06-2018 for 1 month till 25-07-2018//renewed for 4 days on 22-06-2018 till 25-06-2018//renewed on 08-06-2018 for 2 days//renewed on 04-06-2018 for 2 days till 06-06-2018//1K SMS pack on 28-05-2018//renew on 01-12-2017 for 1 month till 31-12-2017//renewed on 02-01-2018 till 31-05-2018", "Sachin Jarhad", "8805983209", "sachinjarhad27@gmail.com", "No Bill Deletion"));
	    ...
	    inputMapClientDtl.put("072.001", new clsClientDetails("072.001", "MOHANLAL S MITHAIWALA", "MOHANLAL S MITHAIWALA", "2015-08-25", "2019-09-14", "Enterprise", "100", objNoSMSPackDtl, "1", "//renewd on 06-09-2018 for one year till 14-09-2019//renewed on 14-09-2017 for 1 year", "Mr.Ansh", "9920985644", "anshmohan@hotmail.com", "No Bill Deletion"));
	    ...
	    inputMapClientDtl.put("074.001", new clsClientDetails("074.001", "THE POONA CLUB LTD", "Poona Club", "2015-09-02", "2018-08-31", "Enterprise", "100", objNoSMSPackDtl, "1", "comment", "Testing", "Testing", "Testing", "No Bill Deletion"));
	    ...
	    inputMapClientDtl.put("092.001", new clsClientDetails("092.001", "Shree Sound Pvt Ltd", "Outlet 1", "2016-01-08", "2018-12-20", "Enterprise", "100", new clsSMSPackDtl("SanguineERP", "2017@SanguineERP@2017", "SANPOS", "Transactional"), "0", "//HO  Waters  renewed on 19-12-2017 to 1 year till 20-12-2018", "", "", "", "No Bill Deletion"));
	    inputMapClientDtl.put("092.002", new clsClientDetails("092.002", "Shree Sound Pvt Ltd", "Outlet 2", "2016-01-08", "2018-12-20", "Enterprise", "100", new clsSMSPackDtl("SanguineERP", "2017@SanguineERP@2017", "SANPOS", "Transactional"), "0", " //Outlet 1  ", "", "", "", "No Bill Deletion"));
	    inputMapClientDtl.put("092.003", new clsClientDetails("092.003", "Shree Sound Pvt Ltd", "Outlet 3", "2016-01-08", "2018-12-20", "Enterprise", "100", new clsSMSPackDtl("SanguineERP", "2017@SanguineERP@2017", "SANPOS", "Transactional"), "0", " //Outlet 2  ", "", "", "", "No Bill Deletion"));
	    ...
	    inputMapClientDtl.put("107.001", new clsClientDetails("107.001", "APT FOODS AND HOSPITALITY", "WHITE ROSE CAFE", "2016-03-23", "2019-03-21", "Enterprise", "100", objNoSMSPackDtl, "1", "//renewed on 10-08-2018 for 1 year till 21-03-2019//white rose cafe renewed on 21-03-2017 for 1 year", "Mr. Pramod", "9820059594", "pramodcall.1@yahoo.com", "No Bill Deletion"));
	    ...
	    inputMapClientDtl.put("117.001", new clsClientDetails("117.001", "THE PREM'S HOTEL", "Prems", "2016-06-30", "2019-06-30", "Enterprise", "100", objNoSMSPackDtl, "50", "//renewed on 18-08-2018 for 1 year till 30-06-2019//renewed on 24-07-2018 till 30-08-2018//renwed on 19-07-2017 for 1 year", "Mr. Avishek Khan", "895627007", "avishek@iceburghospitality.com", "No Bill Deletion"));
	    inputMapClientDtl.put("118.001", new clsClientDetails("118.001", "PICCADILLY RESTAURANT", "Piccadilly", "2016-07-04", "2018-12-05", "Enterprise", "100", objNoSMSPackDtl, "2", "//Added 1 APOS on 24-08-2018 total 2 APOS//renewed on 05-12-2017 for 1 year till 05-12-2018", "Mr. Parvez", "9619441957", "parvez.piccadilly@hotmail.com", "No Bill Deletion"));
	    ...
	    inputMapClientDtl.put("148.001", new clsClientDetails("148.001", "MURPHIES", "MURPHIES", "2017-02-16", "2019-02-15", "Enterprise", "100", new clsSMSPackDtl("Murphies", "2018@Murphies@2018", "SANPOS", "Transactional"), "3", "//renewd 2 APOS on 04-06-2018+ 1K SMS //renewed on 12-04-2018 for bill deletion  //renewed on 17-03-2018 for 1 year till 16-02-2019//renewed on 05-03-2018 for 15 days till 20-03-2018//renewed on 27-02-2018 for 8 days//renewed on 17-02-2018 for 8 days till 19-02-2018//release on 16-02-2017 for 1 year.", "Mr. Aman Talreja", "9823074403", "aman@jenterprises.co.in", "Bill Deletion"));
	    ...
	    inputMapClientDtl.put("150.001", new clsClientDetails("150.001", "AHB HOSPITALITY LLP", "AHB", "2017-02-18", "2019-02-18", "Enterprise", "100", new clsSMSPackDtl("AHBHospitality", "2018@AHBHospitality@2018", "SANPOS", "Transactional"), "0", "//10K SMS Pack on 28-05-2018//renewed on 17-02-2018 for 1 year till 18-02-2019//  release on 18-02-2017 for 1 year", "Mr. Raj", "9920556789", "rajguptapt@gmail.com", "No Bill Deletion"));
	    ...
	    inputMapClientDtl.put("157.001", new clsClientDetails("157.001", "Shah & Sanghvi Hospitality LLP", "SPICE & FLAVOURS RESTAURANT", "2017-03-28", "2019-06-30", "Enterprise", "3", objNoSMSPackDtl, "3", "//renewed on 20-06-2018 for 1 year till 30-06-2019//renewed on 17-03-2018 till 30-06-2018 as per client goes live in 1 july//SPICE & FLAVOURS RESTAURANT renamed to H & S Enterprise, H & S Enterprise renamed to Shah & Sanghvi Hospitality LLP//released on 28-03-2017 for 1 year  Enterprise for 3 machines.", "MR. SAMEER", "07738888886", "sams1137@gmail.com", "No Bill Deletion"));
	    ...
	    inputMapClientDtl.put("171.001", new clsClientDetails("171.001", "CHINA GRILL-PIMPRI", "Chaina Grill", "2017-05-24", "2019-05-24", "Enterprise", "100", new clsSMSPackDtl("ChinaGrill", "2017@ChinaGrill@2017", "SANPOS", "Transactional"), "2", "//renewed on 26-05-2018 for 1 year till 24-05-2019//renewed on 25-05-2018 for 4 days till 28-05-2018// renewed on 17-07-20147 for 1 year  Enterprise for 2 terminals on desktop ...2 days exceeded as per swapnali request and add 1 terminal, 1K SMS Pack activated", "Mr. Dashmesh", "9890034563", "prerana@chinagrill.co.in", "No Bill Deletion"));
	    ...
	    inputMapClientDtl.put("173.001", new clsClientDetails("173.001", "Le Flamington", "Le Flamington", "2017-05-29", "2019-05-29", "Enterprise", "1", objNoSMSPackDtl, "0", "//renewed on 30-05-2018 for 1 year till 29-05-2019// released on 29-05-2017 for 1 year  Enterprise for 1 terminals on desktop", "Mr. Taha Khan", "taha1091@gmail.com", "8007503355", "Bill Deletion"));
	    //Krimpson
	    ...
	    inputMapClientDtl.put("175.001", new clsClientDetails("175.001", "Tjs brew works", "TJ", "2017-06-06", "2018-09-15", "Enterprise", "100", new clsSMSPackDtl("TJsBrew", "2017@TJsBrew@2017", "SANPOS", "Transactional"), "7", "//renewed on 08-09-2018 for  8 days till 15-09-2018//renewed on 31-08-2018 for 7 days till 07-09-2018//renewed on 23-08-2018 till 30-08-2018//renewed on 17-08-2018 till 23-08-2018//renewed on 08-08-2018 till 16-08-2018//renewed on 01-08-2018 for 7 days till 07-08-2018//renewed on 24-07-2018 for 7 days till 31-07-2018//renewed on 16-07-2018 for 7 days till 22-07-2018//renewed on 09-07-2018 for 1 week till 15-07-2018//renewed on 02-07-2018 for 1 week till 08-07-2018//renewed on 19-06-2018 till month end//renewed on 07-06-2018 for 8 days till 13-06-2018 // released on 06-06-2017 for 1 year ,SMS Pack for 1K SMS,  Enterprise for 2 terminals on desktop renewed 2 terminals  to 7", "Ashwini", "9500116246", "brewer@tjsbrewworks.com", "Bill Deletion"));
	    inputMapClientDtl.put("176.001", new clsClientDetails("176.001", "FRANCOPHONE EUROPEAN BISTRO & PATISSERIE", "", "2017-06-07", "2018-06-10", "Enterprise", "1", objNoSMSPackDtl, "4", "//renewed on 08-06-208 for 3 days till 10-06-2018 // released on 07-06-2017 for 1 year  Enterprise for 1 terminals on desktop ", "MR. Tushar", "9870749307,9860508000", "id.guru@francophone.in", "No Bill Deletion"));
	    ...
	    inputMapClientDtl.put("178.001", new clsClientDetails("178.001", "UNWIND", "UNWIND", "2017-06-08", "2019-06-08", "Enterprise", "100", objNoSMSPackDtl, "20", "//renewed on 09-07-2018 for 1 year till 08-06-2019//renewed on 02-07-2018 for 1 week till 08-07-2018//renewed on 18-06-2018 till month end //renewed on 07-06-2018 for 12 days till 18-06-2018//renewed 7 APOS// renewed on 06-07-2017 for 1 year  Enterprise for 6 terminals on desktop ", "Mr. Nikhil Hejib", "7798882008", "nikhilhejib@unwindpune.com", "No Bill Deletion"));
	    ...
	    inputMapClientDtl.put("182.001", new clsClientDetails("182.001", "OOZO", "OOZO", "2017-06-21", "2019-06-21", "Enterprise", "6", objNoSMSPackDtl, "10", "//renewed on 20-06-2018 for 1 year till 21-06-2019//renewed 4 SPOS to 6 SPOS and 12 APOS to 10 APOS//till 21-06-2018// released on 21-06-2017 for 1 month  renewed on 09-08-2017 for 1 year Enterprise for 4 terminals on desktop No SMS Pack", "Mr.FEROZ KHAN", "9920018064", "Fero_oozo@gmail.com", "No Bill Deletion"));
	    inputMapClientDtl.put("183.001", new clsClientDetails("183.001", "VD HOSPITALITY LLP", "", "2017-06-30", "2019-06-30", "Enterprise", "2", objNoSMSPackDtl, "5", "//renewed on 21-06-2018 for 1 year till 30-06-2019// released on 30-06-2017 for 1 year  Enterprise for 2 terminals on desktop No SMS Packs", "Mr.Dipak", "9765288341", "Dipakp.tl@gmail.com", "No Bill Deletion"));
	    //"184.001", "BALAJI TRADERS PVT LTD" only MMS License
	    inputMapClientDtl.put("185.001", new clsClientDetails("185.001", "MOHANLAL S MITHAIWALA", "MOHANLAL S MITHAIWALA", "2017-07-19", "2019-08-19", "Enterprise", "2", objNoSMSPackDtl, "0", "//renewed on 16-08-2018 for 1 year till 19-08-2019//(first license 072.001, MOHANLAL S MITHAIWALA) released on 19-07-2017 for 1 month,renewed on 21-08-2017 for 1 year  Enterprise for 2 terminals on desktop No SMS Pack", "Mr. Ansh", "9920985644", "anshmohan@hotmail.com", "No Bill Deletion"));
	    ...
	    inputMapClientDtl.put("187.001", new clsClientDetails("187.001", "ROSHAN BAKERY", "", "2017-07-19", "2019-07-19", "Enterprise", "2", objNoSMSPackDtl, "0", "//renewed on 21/7/2018 for 1 year // released on 19-07-2017 for 1 month,renewed on 05-10-2017 for 1 year  Enterprise for 2 terminals on desktop No SMS Pack", "Mr.Shapur", "9820021389", "roshan@gmail.com", "No Bill Deletion"));
	    inputMapClientDtl.put("188.001", new clsClientDetails("188.001", "MUMBAI CAFE", "MUMBAI CAFE", "2017-07-20", "2019-07-20", "Enterprise", "2", objNoSMSPackDtl, "2", "//renewed on 19-07-2018 for 1 year till 20-07-2019// released on 20-07-2017 for 1 year  Enterprise for 2 terminals on desktop  and APOS for 2 TAB No SMS Pack", "Mr. Vijay", "9892075163", "vijayshah13@gmail.com", "No Bill Deletion"));
	    ...
	    inputMapClientDtl.put("193.001", new clsClientDetails("193.001", "NAPLES STAPLES", "Precision Food Work", "2017-09-04", "2018-09-10", "Enterprise", "100", objNoSMSPackDtl, "0", "\\192.001 precision food work\" for webStocks //renewed on 01-09-2018 till 10-09-2018// released on 04-09-2017 for 1 year,  Enterprise for 2 terminals on desktop", "Mr. Abhay", "9819093520", "pfw.pune@gmail.com", "No Bill Deletion"));
	    //Swig 2 Prems Restaurant SWIG 2.0 RENAMED TO SWIG
	    inputMapClientDtl.put("194.001", new clsClientDetails("194.001", "SWIG", "SWIG 2", "2017-09-06", "2018-09-15", "Enterprise", "100", objNoSMSPackDtl, "100", "//renewed on 08-09-2018 for 8 days till 15-09-2018 //renewed on 19-04-2018 for 7 APOS //Swig 2 Prems Restaurant SWIG 2.0 RENAMED TO SWIG// released on 06-09-2017 for 1 month renewed on 06-10-2017 for 1 year,  Enterprise for 2 terminals on desktop ,SWIG 2.0 RENAMED TO SWIG", "Mr. Avishek", "8956270007", "avishek@iceburghospitality.com", "No Bill Deletion"));
	    //"COO COUNTRY OF ORIGIN" for 3 locations renamed to "DESIGNSCAPE & COUNTRY OF ORIGIN" renamed to "COUNTRY OF ORIGIN"
	    
	    inputMapClientDtl.put("195.001", new clsClientDetails("195.001", "COUNTRY OF ORIGIN", "", "2017-09-07", "2019-09-06", "Enterprise", "5", objNoSMSPackDtl, "0", "//renewed on 23-08-2018 for 1 year from 06-09-2018 till 06-09-2019 //COO COUNTRY OF ORIGIN for 3 locations renamed to DESIGNSCAPE & COUNTRY OF ORIGIN renamed to COUNTRY OF ORIGIN //(Mumbai) released on 07-09-2017 for 1 year,  Enterprise for 5 terminals added later on desktop and 0 APOS cancel later,NO SMS Pack", "Mr. Kiran", "9820056812", "kiran@countryoforigin.in", "No Bill Deletion"));
	    inputMapClientDtl.put("195.002", new clsClientDetails("195.002", "COUNTRY OF ORIGIN", "", "2017-09-07", "2019-09-06", "Enterprise", "2", objNoSMSPackDtl, "0", "//renewed on 23-08-2018 for 1 year from 06-09-2018 till 06-09-2019 //COO COUNTRY OF ORIGIN for 3 locations renamed to DESIGNSCAPE & COUNTRY OF ORIGIN renamed to COUNTRY OF ORIGIN//(Mumbai) released on 07-09-2017 for 1 year,  Enterprise for 2 terminals on desktop and 0 APOS,NO SMS Pack", "Mr. Kiran", "9820056812", "kiran@countryoforigin.in", "No Bill Deletion"));
	    inputMapClientDtl.put("195.003", new clsClientDetails("195.003", "COUNTRY OF ORIGIN", "", "2017-09-07", "2019-09-06", "Enterprise", "2", objNoSMSPackDtl, "0", "//renewed on 23-08-2018 for 1 year from 06-09-2018 till 06-09-2019 //COO COUNTRY OF ORIGIN for 3 locations renamed to DESIGNSCAPE & COUNTRY OF ORIGIN renamed to COUNTRY OF ORIGIN//(Mumbai) released on 07-09-2017 for 1 year,  Enterprise for 2 terminals on desktop and 0 APOS,NO SMS Pack", "Mr. Kiran", "9820056812", "kiran@countryoforigin.in", "No Bill Deletion"));
	    ...
	    inputMapClientDtl.put("205.001", new clsClientDetails("205.001", "THE SPOONFUEL BISTRO LLP", "SPOONFUEL", "2017-10-20", "2018-10-20", "Enterprise", "1", objNoSMSPackDtl, "2", "//added 2 APOS on 31-01-2018//renewed on 07-11-2017 for 1 year till 20-10-2018,  Enterprise for 1  terminal on desktop, 2 APOS", "", "", "", "No Bill Deletion"));
	    ...
	    inputMapClientDtl.put("217.001", new clsClientDetails("217.001", "BURNT CRUST HOSPITALITY PVT LTD", "", "2017-12-14", "2018-10-03", "Enterprise", "6", objNoSMSPackDtl, "16", "//renewed on 02-08-2018  for 2 months till 03-10-2018//renewed on 03-07-2018 for 1 month till 03-08-2018//renewed on 07-06-2018 for 1 month till 08-07-2018//(MUMBAI)release on 14-12-2017 for 1 month till 2018-01-13 for 6 SPOS and 13 APOS,updated to 16 APOS,1 WebSttocks ,No SMS Pack.", "Mr. Vaibhav", "9833006789", "vaibhavssa@gmail.com", "No Bill Deletion"));
	    ...
	    inputMapClientDtl.put("220.001", new clsClientDetails("220.001", "70 DEGREE EAST", "70 DEGREE", "2017-12-18", "2019-04-17", "Enterprise", "3", objNoSMSPackDtl, "10", "//(MUMBAI)//renewed on 18-05-2018 for 1 year till 17-04-2019//renewed on 17-04-2018 for 1 month till 17-05-2018//release on 18-12-2017 for 1 month till 17-01-2018 for 3 SPOS and 10 APOS,No WebStocks,No SMS Pack.", "MR.Manish", "8169117471", "manishpal.19@gmail.com", "No Bill Deletion"));
	    ...
	    inputMapClientDtl.put("225.001", new clsClientDetails("225.001", "SHEESHA SKY LOUNGE HOSPITALITY AND SERVICES PVT LTD", "", "2018-08-21", "2019-08-21", "Enterprise", "6", objNoSMSPackDtl, "2", "(MUMBAI) //renew on 21-08-2018 for 1 year till 21-08-2019//release on 22-01-2018 for 1 month till 21-02-2018 for 6 SPOS and 2 APOS,1 WebStocks,No SMS Pack.", "MR.Mohd", "9820299206", "Mohdoc.206@gmail.com", "No Bill Deletion"));
	    ...
	    inputMapClientDtl.put("228.001", new clsClientDetails("228.001", "Moti Mahal-MYK Foods and Beverage", "Amanora", "2018-02-21", "2019-02-21", "Enterprise", "10", objNoSMSPackDtl, "1", "(PUNE)//renewed on 16-08-2018 for 1 year till 12-02-2019// renewed licence on 21-07-2018  till 15-08-2018 //renewed on 19-06-2018 for 1 month till 19-07-2018//release on 21-02-2018 for 3 months till 21-05-2018 for 1 HO SPOS,0 APOS,NO WebStocks,No SMS Pack.", "Mr. Mridul Arora", "7378342342", "a.mridul93@gmail.com", "No Bill Deletion"));
	    inputMapClientDtl.put("228.002", new clsClientDetails("228.002", "Moti Mahal-MYK Foods and Beverage", "Phoenix", "2018-02-21", "2018-06-21", "Enterprise", "1", objNoSMSPackDtl, "1", "(PUNE)//release on 21-02-2018 for 3 months till 21-05-2018 for 1 SPOS,0 APOS,NO WebStocks,No SMS Pack.", "Mr. Mridul Arora", "7378342342", "a.mridul93@gmail.com", "No Bill Deletion"));
	    inputMapClientDtl.put("228.003", new clsClientDetails("228.003", "Moti Mahal-MYK Foods and Beverage", "Amanora(HO)Server", "2018-02-21", "2018-06-21", "Enterprise", "1", objNoSMSPackDtl, "1", "(PUNE)//HO Call Center//release on 21-02-2018 for 3 months till 21-05-2018 for 1 SPOS,0 APOS,NO WebStocks,No SMS Pack.", "Mr. Mridul Arora", "7378342342", "a.mridul93@gmail.com", "No Bill Deletion"));
	    ...
	    inputMapClientDtl.put("233.001", new clsClientDetails("233.001", "PLAYBOY INDIA", "PLAYBOY", "2018-04-27", "2018-09-27", "Enterprise", "9", objNoSMSPackDtl, "5", "(MUMBAI)//renewed on 18-06-2018 for 3 months till 27-09-2018//Renew for 2 month on 10-05-2017 till 27-06-2018 and live on 27-04-2018//renewed on 27-04-2018 for 1 month till 27-05-2018//release on 13-03-2018 for 1 months till 12-04-2018  for 9 SPOS ,5 APOS,1 WebStocks,No SMS Pack.", "Mr.Santosh", "9987326701", "Santosh_ply23@gmail.com", "No Bill Deletion"));
	    inputMapClientDtl.put("233.002", new clsClientDetails("233.002", "PLAYBOY INDIA", "PLAYBOY BEER GARDEN", "2018-06-13", "2019-06-13", "Enterprise", "7", objNoSMSPackDtl, "0", "//renewed on 10-08-2018 for 1 year till 13-06-2019//renewed on 13-07-2018 for 1 month till 13-08-2018//release on 13-06-2018 for 1 months till 13-07-2018  for 7 SPOS ,0 APOS,1 WebStocks,No SMS Pack.", "Mr.Santosh", "9987326701", "Santosh_ply23@gmail.com", "No Bill Deletion"));
	    ...
	    inputMapClientDtl.put("238.002", new clsClientDetails("238.002", "HAUTE ARTISAN CREATIONS", "Chembur Outlet 1", "2018-03-21", "2019-03-20", "Enterprise", "2", objNoSMSPackDtl, "0", "(MUMBAI)//renewed on 21-05-2018 for 1 year till 20-03-2019//renewed on 19-04-2018 for 1 month till 20-05-2018//rename on 19-04-2018 SOLLERTIA PRODUCTIONS to HAUTE ARTISAN CREATIONS//release on 21-03-2018 for 1 month till 20-04-2018 for 2 SPOS ,0 APOS,NO WebStocks,No SMS Pack.", "Mr.Bhargav", "9619928491", "bhargav.iyer@gmail.com", "No Bill Deletion"));
	    inputMapClientDtl.put("238.003", new clsClientDetails("238.003", "HAUTE ARTISAN CREATIONS", "Mulund Outlet 2", "2018-03-21", "2019-03-20", "Enterprise", "2", objNoSMSPackDtl, "0", "(MUMBAI)//renewed on 21-05-2018 for 1 year till 20-03-2019//renewed on 19-04-2018 for 1 month till 20-05-2018//rename on 19-04-2018 SOLLERTIA PRODUCTIONS to HAUTE ARTISAN CREATIONS//release on 21-03-2018 for 1 month till 20-04-2018 for 2 SPOS ,0 APOS,NO WebStocks,No SMS Pack.", "Mr.Bhargav", "9619928491", "bhargav.iyer@gmail.com", "No Bill Deletion"));
	    ...
	    inputMapClientDtl.put("239.001", new clsClientDetails("239.001", "KARMA HOSPITALITY", "URBO", "2018-03-22", "2019-03-22", "Enterprise", "4", objNoSMSPackDtl, "8", "(PUNE Urbo)//renewed on 13-06-2018 for 1 year till 22-30-2019//renewed on 23-05-2018 for 1 month till 22-06-2018//renewed on 21-04-2018 for 1 month till 22-05-2018//release on 22-03-2018 for 1 month till 22-04-2018 for 4 SPOS ,8 APOS,NO WebStocks,No SMS Pack.", "Mr. Nitesh Kyada", "9764656565", "niteshkyada@gmail.com", "No Bill Deletion"));
	    inputMapClientDtl.put("240.001", new clsClientDetails("240.001", "THOUSAND OAKS", "1000 OAKS", "2018-03-27", "2018-09-27", "Enterprise", "5", objNoSMSPackDtl, "10", "(PUNE)//renewed on 28-08-2018 for 1 month till 27-09-2018//renewed on 20-08-2018 till 27-08-2018//renewed on 11-08-2018 for 1 week till 18-08-2018//renewed on 03-08-2018 for 1 week till 10-08-2018//renewed on 26-07-2018 for 8 days till 02-08-2018//renewed on 13-07-2018 for 15 days till 26-07-2018//renewed on 12-06-2018 for 1 month till 11-07-2018//renewed for 1 month on 12-05-2018//renewed on 25-04-2018 for 15 days till 11-05-2018//release on 27-03-2018 for 1 month till 26-04-2018 for 5 SPOS ,10 APOS,NO WebStocks,No SMS Pack.", "Mr. Shripad Tole", "8308318356", "info@1000oaksindia.com", "Bill Deletion"));
	    inputMapClientDtl.put("241.001", new clsClientDetails("241.001", "LALITHA HOSPITALITY PVT LTD", "", "2018-04-06", "2019-04-06", "Enterprise", "4", objNoSMSPackDtl, "6", "(MUMBAI)//renewed on 13-06-2018 for 1 year till 06-04-2019//release on 06-04-2018 for 1 month till 06-05-2018//renew on 08-05-2018 for 1 month till 08-06-2018 for 4 SPOS ,6 APOS,1 WebStocks,No SMS Pack.", "Mr.Santosh Shetty", "+919769214553", "Santoshshetty_0173@gmail.com", "No Bill Deletion"));
	    //242.001, "SRINATHJIS CUISINES PVT LTD" MMS License
	    inputMapClientDtl.put("243.001", new clsClientDetails("243.001", "SURANIMO RETAIL PRIVATE LIMITED", "QILLA", "2018-04-11", "2019-04-11", "Enterprise", "5", objNoSMSPackDtl, "3", "(MUMBAI)//change SPOS n APOS License//renewed on 02-06-2018 for 1 year till 11-04-2019//renewd on 11-5-18 for 1 month//release on 11-04-2018 for 1 month till 11-05-2018 for 5 SPOS ,3 APOS,NO WebStocks,No SMS Pack.", "Mr.Arya", "9617894217", "Aryapatil231@gmail.com", "No Bill Deletion"));
	    ...
	    inputMapClientDtl.put("245.001", new clsClientDetails("245.001", "LSD NO LIMITS LLP (C/O)", "RAJURESHWAR HOSPITALITY PVT LTD", "2018-04-19", "2019-04-19", "Enterprise", "5", objNoSMSPackDtl, "7", "(MUMBAI)//renewed on 30-05-2018 for 1 year till 19-04-2019//renewed on 21-05-2018 for 1 week till 27-05-2018//renamed LSD NO LIMITS LLP & (C/O) to LSD NO LIMITS LLP (C/O)//release on 19-04-2018 for 1 month till 19-05-2018 for 5 SPOS ,7 APOS,1 WebStocks,No SMS Pack.", "Mr.Raj", "9912260717", "rajluv.lsd@gmail.com", "No Bill Deletion"));
	    inputMapClientDtl.put("246.001", new clsClientDetails("246.001", "FUNKY MONKEYS PLAY CENTERS PVT LTD", "Funky Monkeys", "2018-05-03", "2019-05-03", "Enterprise", "4", objNoSMSPackDtl, "2", "(AHMEDABAD)//renewed on 02-07-2018 for 1 year till 03-05-2019//renewed on 01-06-2018 for 1 month till 30-06-2018//Rename on 11-05-2018 //release on 03-05-2018 for 1 month till 03-06-2018 for 4 SPOS ,2 APOS,NO WebStocks,No SMS Pack,No Bill Deletion.", "Mr.Naresh", "09821795551", "admin@funkymonkeys.in", "No Bill Deletion"));
	    ...
	    inputMapClientDtl.put("248.001", new clsClientDetails("248.001", "MARAASIM", "MARAASIM", "2018-05-26", "2019-05-26", "Enterprise", "1", objNoSMSPackDtl, "0", "(MUMBAI)//release on 26-05-2018 for 1 year till 26-05-2018 for 1 SPOS ,0 APOS,NO WebStocks,No SMS Pack,No Bill Deletion.", "Mr.Khalid Bhai", "9930786555", "Khalid555@gmail.com", "No Bill Deletion"));
	    inputMapClientDtl.put("249.001", new clsClientDetails("249.001", "FINOM CAKE STOP", "FINOM CAKE STOP", "2018-05-29", "2019-05-28", "Enterprise", "2", objNoSMSPackDtl, "0", "(MUMBAI)//release on 29-05-2018 for 1 year till 28-05-2018 for 2 SPOS ,0 APOS,NO WebStocks,No SMS Pack,No Bill Deletion.", "Mr.Yusuf", "7767156490", "finomcakes@gmail.com", "No Bill Deletion"));
	    inputMapClientDtl.put("250.001", new clsClientDetails("250.001", "SHREE LAKSHMI FOODS AND HOSPITALITY LLP", "KAREEMS", "2018-05-29", "2019-05-28", "Enterprise", "3", objNoSMSPackDtl, "0", "(MUMBAI)//release on 29-05-2018 for 1 year till 28-05-2018 for 3 SPOS ,0 APOS,NO WebStocks,No SMS Pack,No Bill Deletion.", "Mr. KAREEMS", "9324652345", "Shreelaks.ask@ymail.com", "No Bill Deletion"));
	    inputMapClientDtl.put("251.001", new clsClientDetails("251.001", "Tribe Hospitality", "NOMAD", "2018-06-01", "2019-06-01", "Enterprise", "1", objNoSMSPackDtl, "3", "(PUNE)//renewed on 28-06-2018 for 1 year till 01-06-2019//release on 01-06-2018 for 1 month till 30-06-2018 for 1 SPOS ,3 APOS,NO WebStocks,No SMS Pack,No Bill Deletion.", "Mr. Vaibhav Maindad", "9860311176", "vaibhav4949@gmail.com", "No Bill Deletion"));
	    inputMapClientDtl.put("252.001", new clsClientDetails("252.001", "Delhi Swad", "Delhi Swad", "2018-06-20", "2019-06-20", "Enterprise", "4", objNoSMSPackDtl, "2", "(PUNE)//increase 2 terminal due to 2 LAN//renewed on 14-08-2018 till 20-06-2019//release on 20-06-2018 for 2 month till 20-08-2018 for 2 SPOS ,2 APOS,NO WebStocks,No SMS Pack,No Bill Deletion.", "Mr. Yogesh Kaushik", "9822058956", "delhiswad@yahoo.com", "No Bill Deletion"));
	    inputMapClientDtl.put("253.001", new clsClientDetails("253.001", "IMPRESARIO ENTERTAINMENT & HOSPITALITY PVT LTD", "FLEA BAZAAR CAFE", "2018-06-21", "2019-06-21", "Enterprise", "2", objNoSMSPackDtl, "0", "(MUMBAI)//release on 21-06-2018 for 1 year till 21-06-2019 for 2 SPOS ,0 APOS,NO WebStocks,No SMS Pack,No Bill Deletion.", "Mr.Rajkumar", "9619863236", "rajkumar@Impresario.in", "No Bill Deletion"));
	    inputMapClientDtl.put("254.001", new clsClientDetails("254.001", "GDM FOODS", "TOSS & GRILL", "2018-06-21", "2019-06-21", "Enterprise", "2", objNoSMSPackDtl, "0", "(MUMBAI)//release on 21-06-2018 for 1 year till 21-06-2019 for 2 SPOS ,0 APOS,NO WebStocks,No SMS Pack,No Bill Deletion.", "Mr.MAHESH", "9820875167", "Masheshgm.79@gmail.com", "No Bill Deletion"));	    
	    inputMapClientDtl.put("255.001", new clsClientDetails("255.001", "Soulstice", "THE HOOD", "2018-07-26", "2019-07-26", "Enterprise", "3", objNoSMSPackDtl, "0", "(MUMBAI)//renewed on 30-07-2018 for 1 year till 26-07-2019//release on 26-07-2018 for 1 month till 26-08-2019 for 3 SPOS ,0 APOS,NO WebStocks,No SMS Pack,No Bill Deletion.", "Mr. Piyush", "9920678744", "piyushshah32@gmail.com", "No Bill Deletion"));	    
	    inputMapClientDtl.put("256.001", new clsClientDetails("256.001", "ASHOK CATERERS", "MATOSHREE CLUB", "2018-08-01", "2019-08-01", "Enterprise", "4", objNoSMSPackDtl, "2", "(MUMBAI)//released on 01-08-2018 for 1 year till 01-08-2019 for 4 SPOS ,2 APOS,NO WebStocks,No SMS Pack,No Bill Deletion.", "Mr.Amey", "9820857234", "Amey_mor@gmail.com", "No Bill Deletion"));	    
	    inputMapClientDtl.put("257.001", new clsClientDetails("257.001", "BLACK SHEEP HOSPITALITY PVT LTD", "CAFE ZOE", "2018-08-16", "2018-11-16", "Enterprise", "10", objNoSMSPackDtl, "4", "(MUMBAI)//renewed on 06-09-2018 for 3 months till 16-11-2018 //released on 16-08-2018 for 1 month till 16-09-2018 for 10 SPOS ,4 APOS,1 WebStocks,No SMS Pack,No Bill Deletion.", "Mr.Jeriemi", "9833131029", "info@blacksheepers.com", "No Bill Deletion"));
	...
	try
	{
	    ...
	    FileWriter fileClientDetailWriter = new FileWriter(fileClientDtl);
		...
		fileClientDetailWriter.write(clientCode + "!" + objValue.getStrClientName());
		fileClientDetailWriter.write("!" + objValue.getStrOutletName());
		fileClientDetailWriter.write("!" + objValue.getDteInstallationDate());
		fileClientDetailWriter.write("!" + objValue.getDteExpiryDate());
		fileClientDetailWriter.write("!" + objValue.getStrPOSVersion());

		int noOfSPOSLicenses = Integer.parseInt(objValue.getIntMAXSPOSTerminal());
		int noOfAPOSLicenses = Integer.parseInt(objValue.getIntMAXAPOSTerminals());
		String webStocks = "No WebStocks";
		if (objValue.getStrComments().contains("1 WebStocks"))
		{
		    webStocks = "1 WebStocks";
		}
		String billDeletion = "No Bill Deletion";
		if (objValue.getStrBillRegeneration().equalsIgnoreCase("Bill Deletion"))
		{
		    billDeletion = "Bill Deletion";
		}
		String smsPack = objValue.getObjSMSPackDtl().getStrSMSPack();
		fileClientDetailWriter.write("!" + noOfSPOSLicenses + " SPOS" + "," + noOfAPOSLicenses + " APOS" + "," + webStocks + "," + billDeletion + "," + smsPack);

		fileClientDetailWriter.write("!" + objValue.getStrContactPerson());
		fileClientDetailWriter.write("!" + objValue.getStrContactNo());
		fileClientDetailWriter.write("!" + objValue.getStrEmailId());

		fileClientDetailWriter.write("!" + objValue.getStrComments());
		fileClientDetailWriter.write("\n");
	    }
	    fileClientDetailWriter.close();

	    File license = new File("License.txt");
	    FileWriter licenseWriter = new FileWriter(license);
		...
		if (strContactPerson.trim().isEmpty() || strContactNo.trim().isEmpty() || strEmailId.trim().isEmpty())
		{
		    ...
		    licenseWriter.append(" " + clientCode + " Please provide client details(Contact person,contact no.,email id) to generate the license");
		    licenseWriter.append("\n");
		}
		else
		{
		    ...
		    licenseWriter.append("/*" + clientCode + "*/" + "hmClientDtl.put(\"" + arrEncryptedClientList.get(0) + "\", createClientDetails(\"" + arrEncryptedClientList.get(0) + "\", \"" + arrEncryptedClientList.get(1) + "\",\"" + arrEncryptedClientList.get(16) + "\" "
